...
const featureSections: FeatureSectionData[] = [
  {
    tag: "AI-tagging",
    title: "Automatische tags met architectuur-vakjargon",
    description:
      "Onze AI herkent niet alleen objecten, maar begrijpt architectuurtermen. Materialen, stijlen, constructies — alles wordt automatisch getagd in de taal die je team gebruikt.",
    bullets: [
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-accent/10 px-3 py-2">
            ...
            <span className="text-xs text-accent-dark font-medium">
              AI heeft 12 tags automatisch toegevoegd
            </span>
          </div>
        </div>
      </FeatureVisual>
  ...
  {
    tag: "Semantic search",
    title: "Zoek in gewone taal, vind exact wat je bedoelt",
    description:
      "Vergeet exacte bestandsnamen. Beschrijf wat je zoekt — 'moderne villa met houten gevel' — en Beeldenbank vindt de juiste foto's. Powered by AI die context begrijpt.",
    bullets: [
  ...
  {
    tag: "Organisatie",
    title: "Projectmappen die meedenken",
    description:
      "Structureer je beeldenbank per project, fase of locatie. Met slimme mappen die automatisch categoriseren, heb je altijd overzicht — hoe groot je archief ook wordt.",
    bullets: [
  ...
  {
    tag: "Samenwerking",
    title: "Team accounts & favorieten",
    description:
      "Werk samen met je hele team. Deel selecties, sla favorieten op, en geef feedback — alles in één centrale plek die voor iedereen toegankelijk is.",
    bullets: [
  ...
  {
    tag: "Bewerken",
    title: "Tags bewerken & AI leert mee",
    description:
      "Pas tags aan, verwijder irrelevante labels of voeg je eigen termen toe. De AI leert van je aanpassingen en wordt steeds slimmer voor jouw bureau.",
    bullets: [
      "Tags toevoegen, verwijderen en hernoemen",
      "AI leert van elke correctie",
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 rounded-lg bg-accent/10 px-3 py-2">
            ...
            <span className="text-xs font-medium text-accent-dark">
              AI leert: &quot;duurzaam&quot; relevanter voor dit projecttype
            </span>
          </div>
        </div>
      </FeatureVisual>
  ...
  {
    tag: "Upload",
    title: "Bulk upload & drag-and-drop",
    description:
      "Sleep volledige mappen of honderden bestanden tegelijk naar Beeldenbank. De AI draait op de achtergrond — je kunt gewoon doorwerken terwijl alles wordt verwerkt.",
    bullets: [
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 rounded-lg bg-background px-3 py-2">
              ...
              <span className="flex-1 text-xs text-text">batch_villa_parkzicht.zip</span>
            ...
            <div className="flex items-center gap-3 rounded-lg bg-background px-3 py-2">
              <GripVertical size={12} className="text-text-muted/40" />
              <span className="flex-1 text-xs text-text">kantoor_west_fase2/</span>
  ...
  {
    tag: "Vocabulaire",
    title: "Vocabulaire beheer op maat",
    description:
      "Elk bureau heeft eigen termen en jargon. Met vocabulaire beheer pas je de AI aan op jullie specifieke taal, zodat tags en zoekresultaten altijd relevant zijn.",
    bullets: [
    ...
    <>
      ...
      <section className="bg-surface pb-16 pt-12 md:pb-20 md:pt-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          >
            <TagBadge className="mb-6">Features</TagBadge>
            ...
            <p className="mx-auto max-w-xl text-lg leading-[1.7] text-text-muted">
              Ontdek alle features die Beeldenbank de slimste keuze maken voor
              architectenbureaus die grip willen op hun beeldarchief.
            </p>
          </motion.div>
        </div>
      </section>
